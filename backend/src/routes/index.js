...
import accessContextRoutes from './v1/accessContext.routes.js';
import adminAccessRoutes from './v1/adminAccess.routes.js';
...
router.use('/v1/accesos', accessContextRoutes);
router.use('/v1/admin/accesos', adminAccessRoutes);
