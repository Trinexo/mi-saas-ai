...
- Estado bloqueo backend: `/tests/generate` y `/tests/generate-refuerzo` bloquean tests libres si la oposicion resuelta esta en `Modo Albacer`; los tests deben iniciarse desde modulos Albacer.
